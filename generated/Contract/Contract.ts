...
export class Contract extends ethereum.SmartContract {
  ...
  returnStructTicket(nftIndex: BigInt): Contract__returnStructTicketResultValue0Struct {
    let result = super.call(
      "returnStructTicket",
  ...
  try_returnStructTicket(nftIndex: BigInt): ethereum.CallResult<Contract__returnStructTicketResultValue0Struct> {
    let result = super.tryCall(
      "returnStructTicket",
      "returnStructTicket(uint256):((address,bytes32[],uint256[],bool,bool,bool))",
      [ethereum.Value.fromUnsignedBigInt(nftIndex)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(value[0].toTuple() as Contract__returnStructTicketResultValue0Struct);
  }
  ...
  ticketMetadataAddress(ownerAddress: Address): Contract__ticketMetadataAddressResult {
    let result = super.call(
  ...
  try_ticketMetadataAddress(ownerAddress: Address): ethereum.CallResult<Contract__ticketMetadataAddressResult> {
    let result = super.tryCall(
      "ticketMetadataAddress",
      "ticketMetadataAddress(address):(address,bytes32[],uint256[],bool,bool,bool)",
      [ethereum.Value.fromAddress(ownerAddress)]
  ...
  try_ticketMetadataIndex(nftIndex: BigInt): ethereum.CallResult<Contract__ticketMetadataIndexResult> {
    let result = super.tryCall(
      "ticketMetadataIndex",
      "ticketMetadataIndex(uint256):(address,bytes32[],uint256[],bool,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(nftIndex)]
