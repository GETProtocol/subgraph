...
export class EventMetaData extends ethereum.SmartContract {
  ...
  ): ethereum.CallResult<EventMetaData__getEventDataResult> {
    let result = super.tryCall(
      "getEventData",
      "getEventData(address):(address,address,string,string,string,bytes32[4],uint256[2],bool,bytes32[],bool)",
      [ethereum.Value.fromAddress(eventAddress)]
  ...
  returnStructEvent(
    eventAddress: Address
  ): EventMetaData__returnStructEventResultValue0Struct {
    let result = super.call(
      "returnStructEvent",
  ...
  try_returnStructEvent(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as EventMetaData__returnStructEventResultValue0Struct
    );
  }
}
