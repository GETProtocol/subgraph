...
export class Relayer extends Entity {
  ...
  get mintsCount(): BigInt {
    let value = this.get("mintsCount");
    return value.toBigInt();
  }

  set mintsCount(value: BigInt) {
    this.set("mintsCount", Value.fromBigInt(value));
  }

  get scansCount(): BigInt {
    let value = this.get("scansCount");
    return value.toBigInt();
  }

  set scansCount(value: BigInt) {
    this.set("scansCount", Value.fromBigInt(value));
  }
