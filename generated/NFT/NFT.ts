...
export class NFT extends ethereum.SmartContract {
  ...
  returnStructTicket(
    nftIndex: BigInt
  ): NFT__returnStructTicketResultValue0Struct {
    let result = super.call(
      "returnStructTicket",
  ...
  try_returnStructTicket(
    nftIndex: BigInt
  ): ethereum.CallResult<NFT__returnStructTicketResultValue0Struct> {
    let result = super.tryCall(
      "returnStructTicket",
      "returnStructTicket(uint256):((address,bytes32[],uint256[],bool,bool,bool))",
      [ethereum.Value.fromUnsignedBigInt(nftIndex)]
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as NFT__returnStructTicketResultValue0Struct
    );
  }
  ...
  ticketMetadataAddress(
    ownerAddress: Address
  ): NFT__ticketMetadataAddressResult {
    let result = super.call(
      "ticketMetadataAddress",
  ...
  try_ticketMetadataAddress(
    ownerAddress: Address
  ): ethereum.CallResult<NFT__ticketMetadataAddressResult> {
    let result = super.tryCall(
      "ticketMetadataAddress",
      "ticketMetadataAddress(address):(address,bytes32[],uint256[],bool,bool,bool)",
      [ethereum.Value.fromAddress(ownerAddress)]
  ...
  try_ticketMetadataIndex(
    nftIndex: BigInt
  ): ethereum.CallResult<NFT__ticketMetadataIndexResult> {
    let result = super.tryCall(
      "ticketMetadataIndex",
      "ticketMetadataIndex(uint256):(address,bytes32[],uint256[],bool,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(nftIndex)]
